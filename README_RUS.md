# T02D02: Первая программа на языке программирования С
Аннотация: Данный проект позволит тебе познакомиться с базовыми операциями на языке С, такие как ввод, ввывод, арифметика.
