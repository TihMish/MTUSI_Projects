...
a13, h13 = 18, True
print("Доступ разрешён" if a13 >= 18 and h13 else "Доступ запрещён")
...
n14, s14 = int(input("Количество измерений: ")), 0.0
for i14 in range(n14):
    s14 += float(input(f"Измерение {i14 + 1}: "))
print(s14, s14 / n14, sep='\n')
