# Название проекта T01D01 и T02D02
Аннотация:Данный проект позволит тебе познакомиться (ОБЪЕДИНИТЬ 1 И 2 проект)
...
Теперь ты находишься в комнате за номером 2.
