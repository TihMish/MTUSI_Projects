...
_\> Atrofga nazar solish_

Siz noma'lum xonadasiz. Oldingizda eski IBM PC kompyuteri bo'lgan kichik stol turibdi. Stol ustida - issiq, shinam yorug'lik beruvchi Pixarga mos stol lampasi, bir nechta sarg'aygan qog'oz varaqlari va bir finjon qaynoq qahva. Ro'parada yopiq eshik. Aftidan, qulf elektron bo'lsa kerak, chunki unda na tutqich, na qulf bor.

_\> Eshikni itarish_

Tutqich yo'q. Tortadigan joyi ham yo'q.

_\> Eshikka zarb berish_

Og'riyapti. Va boshqa hech qanday ta'sir yo'q.

_\> Stol oldiga o'tirish_
...
_\> Sichqonchani qidirish_

Sichqoncha yo'q.

_\> Oynalarni qidirish_

Oyna ham yo'q. Faqat eshik. Ekranda ham oyna yo'q...

_\> Enter tugmasini bosish_
...
_\> Ekranga yana bir bor qarash_
...
_\> "Bu yerdan qanday chiqib ketish mumkin?" degan savolni berish._

Matnlar uyumidan "srs/ai_door_management_module.sh bilan gaplashib ko'ring" degan satrni topishga muvaffaq bo'lasiz.

_\> src/ai_door_management_module.sh ni ishga tushirish_
...
_\> To'g'risini aytsam, unchalik emas._
...
_\> Ochiq eshiklar konfiguratsiyasiga ega bo'lgan direktoriyani ochish._

Ochiq. Fayllar bu yerda. Siz ularni allaqachon ko'rgansiz.

_\> Birinchi eshik uchun konfiguratsiya faylini ochish_
...
_\> Fayllarni ko'rishda va terminalni o'qishda davom etish_
...
_\> ls buyrug'i yordamida src/ai_help direktoriya fayllari ro'yxatini chiqarish_
...
_\> Bu chiqish joyi emasmidi? Qayerdaman o'zi?_
...
_\> Kompyuterni stol ustiga qo'yish_
...
_\> Hammasini rozetkaga tortish_

Siz butun konstruksiyani rozetkaga olib borasiz.

_\> Kompyuterni rozetkaga ulash_
...
_\> Tugmalarni terish... hatto bilmayman... Terminalda shunchaki qandaydir "qwe"_
...
_\> Terish: "Menga keraksan. Men bu yerdan chiqish yo'lini izlayapman"._
...
Hozir 2001-yil emas-ku? Uni, albatta, "Vim"da to'ldir. (Bu muhim! Men uchun...) Tugatganingdan so'ng, jurnalga (src/files.log fayliga) quyidagi formatda kirit: faylga yo'l (ildiz direktoriyasiga nisbatan) - fayl hajmi - sana va vaqt - sha-fayl yig'indisi (sha256 ni afzal ko'raman) - sha hisoblash algoritmi.
...
_\> Terish: "Endi chiqish mumkinmi?"_
...
_\> Zo'r. Bu skriptlar qanday yozilishini bilsam edi..._
...
_\> Terish: "Bu endi adolatdan emas!"_
...
3\. developda merge request yaratish.
...
**Bu loyiha haqida fikr-mulohazalar bildirish uchun bu yerga bosing. Bu anonim bo'lib, jamoamizga ta'limni yaxshilashga yordam beradi. So'rovnomani loyiha bajarilgandan so'ng darhol to'ldirishni tavsiya qilamiz.**